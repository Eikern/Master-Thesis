...
execute_unload 'results_master_20_5_min_s2_import_power.gdx'
    import_power,
    solar,
    hp_lower,
    hp_upper,
    ...
    export_energy
    ;
execute 'gdx2sqlite -i results_master_20_5_min_s2_import_power.gdx -o scenario2/basecase_20/results_master_20_5_min_s2_import_power.db -fast';
