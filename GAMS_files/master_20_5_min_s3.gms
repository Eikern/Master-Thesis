...
execute_unload 'results_master_20_5_min_s3_import_power.gdx'
    import_power,
    solar,
    hp_lower,
    hp_upper,
    ...
    export_sale
    ;
execute 'gdx2sqlite -i results_master_20_5_min_s3_import_power.gdx -o scenario3/basecase_20/results_master_20_5_min_s3_import_power.db -fast';
