...
parameter
    scaling_dhw(z) /z1 0.50, z2 0.60, z3 0.70, z4 0.80, z5 0.9/;
    

Parameter fixedload_original(t)
/
$include "C:/Users/eirik/OneDrive/Skrivebord/Master/Masteroppgave/data/5_min_data/fixed_load_5_min_data_20_gams.tsv"
/
;
...
$include "C:/Users/eirik/OneDrive/Skrivebord/Master/Masteroppgave/data/5_min_data/solar_prod_5_min_data_20_gams.tsv"
/
;
Parameter price(h)
/
...
;
Parameter utetemp(t)/
$include "C:/Users/eirik/OneDrive/Skrivebord/Master/Masteroppgave/data/5_min_data/mean_value_5_min_data_20_gams.tsv"
/
;
...
execute_unload 'sensitivity_results_20_sens.gdx', results,solar_values,hp_lower_values,hp_upper_values;
execute 'gdx2sqlite -i sensitivity_results_20_sens.gdx -o sensitivity/results_master_20_5_min_import_power_sens.db -fast';
