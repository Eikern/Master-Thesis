...
heat_pump_system.optcr = 0.03;
Solve heat_pump_system using mip minimizing obj;

execute_unload 'results_master_18_5_min_s1_total_cost.gdx'
    import_power,
    solar,
    hp_lower,
    hp_upper,
    ...
    export_energy
    ;
execute 'gdx2sqlite -i results_master_18_5_min_s1_total_cost.gdx -o scenario1/basecase_18/results_master_18_5_min_s1_total_cost.db -fast';
