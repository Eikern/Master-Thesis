...
heat_pump_system.optcr = 0.045;
Solve heat_pump_system using mip minimizing obj;

execute_unload 'results_master_18_5_min_s2_total_cost.gdx'
    import_power,
    solar,
    hp_lower,
    hp_upper,
    ...
    export_energy
    ;
execute 'gdx2sqlite -i results_master_18_5_min_s2_total_cost.gdx -o scenario2/basecase_18/results_master_18_5_min_s2_total_cost.db -fast';
