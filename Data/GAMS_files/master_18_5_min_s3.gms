...
execute_unload 'results_master_18_5_min_s3_total_cost.gdx'
    import_power,
    solar,
    hp_lower,
    hp_upper,
    ...
    export_sale
    ;
execute 'gdx2sqlite -i results_master_18_5_min_s3_total_cost.gdx -o scenario3/basecase_18/results_master_18_5_min_s3_total_cost.db -fast';
