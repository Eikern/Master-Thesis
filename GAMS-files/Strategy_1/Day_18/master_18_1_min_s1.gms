...
$include "C:/Users/eirik/OneDrive/Skrivebord/Master/Masteroppgave/data/1_min_data/solar_prod_1_min_data_18_gams.tsv"
/
;
Parameter price(h)
/
...
;
Parameter utetemp(t)/
$include "C:/Users/eirik/OneDrive/Skrivebord/Master/Masteroppgave/data/1_min_data/mean_value_1_min_data_18_gams.tsv"
/
;
Parameter fixedload(t)
/
$include "C:/Users/eirik/OneDrive/Skrivebord/Master/Masteroppgave/data/1_min_data/fixed_load_1_min_data_18_gams.tsv"
/
;
Parameter shower(t)
/
...
heat_in_room_max(t)..heat_in_room(t) =L=bigM * heat_room_on(t);
...
execute_unload 'results_master_18_1_min_s1_total_cost.gdx'
    import_power,
    solar,
    hp_lower,
    hp_upper,
    ...
    export_energy
    ;
execute 'gdx2sqlite -i results_master_18_1_min_s1_total_cost.gdx -o scenario1/basecase_18/results_master_18_1_min_s1_total_cost.db -fast';
